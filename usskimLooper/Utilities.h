...
// float getNjetSFfromLLG(int njet, int year, string systype) {
//   float sfval = 1.0;
//   float sferr = 0.0;
//   // 0.928 +- 0.0247,  0.927 +- 0.0431,  0.893 +- 0.0734
//   if (year == 2018) {
//     if (njet == 0) {
//       sfval = 0.928;
//       sferr = 0.025;
...
//     }
//   }
//   // 0.965 +- 0.0318,  1.012 +- 0.0557,  0.931 +- 0.0887,
//   if (year == 2017) {
//     if (njet == 0) {
//       sfval = 0.928;
//       sferr = 0.025;
...
//     }
//   }
//   // 1.037 +- 0.0335,  0.910 +- 0.0524,  0.807 +- 0.0950,
//   if (year == 2016) {
//     if (njet == 0) {
//       sfval = 1.037;
//       sferr = 0.0335;
...
int getDileptonID(unsigned int evtnum, int year) {

  if (year == 2018) {
    if (evtnum % 1000 < 588) return -169;
    else return -121;
  }
  if (year == 2017) {
    if (evtnum % 1000 < 596) return -169;
    else return -121;
  }
  if (year == 2016) {
    if (evtnum % 1000 < 608) return -169;
    else return -121;
  }
