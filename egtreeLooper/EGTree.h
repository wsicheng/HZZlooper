...
// Generated with command: -t EGTree -n tas -o st -c EGTree -plv /hadoop/cms/store/user/usarica/Offshell_2L2Nu/Worker/output/SinglePhotonEGTnP/SkimTrees/210107/AK4Jets_WithPUJetId_NoTightLeptonJetId_ParticleCleaned/PFMET_WithXY_WithPartMomCorr_P4Preserved/2018A/EGamma_Run2018A-17Sep2018-v2_Nominal_chunk_0_of_2.root 
...
protected:
  ...
  vector<float> *weight_HLT_Photon20_HoverELoose_;
  TBranch *weight_HLT_Photon20_HoverELoose_branch;
  bool weight_HLT_Photon20_HoverELoose_isLoaded;
  vector<float> *weight_HLT_Photon30_HoverELoose_;
  TBranch *weight_HLT_Photon30_HoverELoose_branch;
  bool weight_HLT_Photon30_HoverELoose_isLoaded;
...
public:
  ...
  const vector<float> &weight_HLT_Photon20_HoverELoose();
  const vector<float> &weight_HLT_Photon30_HoverELoose();
